...
d3.csv("data/4. Economy/Data/fig_4.2.3.csv").then(function(data) {
    ...
    // Demand index = normalized percentage (0-100 scale based on max value across all skills)
    ...
    const skillTimeSeries = allSkills.map(skill => {
        ...
        for (let year = 2017; year <= 2024; year++) {
            ...
            if (yearData) {
                timeSeries.push({
                    ...
                    demandIndex: (yearData.percentage / maxPercentage) * 100 // Normalize to 0-100
                });
            }
        }
        
        // Project 2025 based on recent trend (2022-2024)
        ...
        // Calculate total growth for sorting
    ...
    // Sort by end value (2024/2025) and take top 8 skills for clarity
    ...
    // Add dots for key years (2017, 2020, 2024, 2025)
